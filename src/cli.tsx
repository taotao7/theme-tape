...
Usage:
  ...
  theme-tape configure [all|ghostty|warp|tmux|nvim|yazi|opencode]
  theme-tape install [--theme all|cassette-futurism|zenith] [--components all|ghostty,warp,tmux,nvim,yazi,opencode]
  theme-tape apply [--theme toggle|cassette|cassette-futurism|zenith] [--mode toggle|dark|light] [--components all|ghostty,warp,tmux,nvim,yazi,opencode]
